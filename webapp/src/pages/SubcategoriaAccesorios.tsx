...
const SubcategoriaAccesorios = () => {
    ...
    const getProductos = async (numbPage : number) => {
        const respuesta = await fetch("http://localhost:5000/product/list/sub_category/Accesorios/"  + numbPage);
...
export default SubcategoriaAccesorios;
                    ...
                    <tr key={producto._id} className="flex flex-row border-b items-center text-center justify-around">
                        <td className="basis-80">
                            <Link to={"/productos/" + pedido._id} className="flex items-center">
                                <img src={producto.image} alt="Imagen de producto" className="w-28 py-2"></img>
                        ...
                        <td className='basis-36'>
                            <Link to={"/pedidos/" + pedido._id} className='inline-block text-center px-4 py-2 text-sm font-medium text-white bg-indigo-600 border border-indigo-600 rounded active:text-indigo-500 hover:bg-transparent hover:text-indigo-600 focus:outline-none focus:ring'>Ver pedido</Link>
                        </td>
                    </tr>
                ))}
            </tbody>
